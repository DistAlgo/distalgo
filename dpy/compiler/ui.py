...
def dpyast_from_file(filename, args=None):
...
def dpyfile_to_pyast(filename, args=None):
    """Translates the given DistPy source file into Python code. Returns an AST
       representation of the result.

    """
    dpyast = dpyast_from_file(filename, args)
    if dpyast is None:
...
def dpyfile_to_pyfile(args):
    ...
    pyast = dpyfile_to_pyast(filename, args)
...
def dpyfile_to_incfiles(args):
    """Compiles a DistPy source file to Python file and generate an interface
...
def main(argv=None):
    ...
    if args.genpsd:
        res =dpyfile_to_pseudofile(args.infile, args.psdfile)
    elif args.geninc:
        res = dpyfile_to_incfiles(args)
    else:
        res = dpyfile_to_pyfile(args)
